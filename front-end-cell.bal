...
cellery:Component frontEndComponent = {
    ...
    dependencies: {
        productsCellDep: <cellery:ImageName>{ org: "dakshitha", name: "products-cell", ver: "1.0.0"},
        adsCellDep: <cellery:ImageName>{ org: "dakshitha", name: "ads-cell", ver: "1.0.0"},
        cartCellDep: <cellery:ImageName>{ org: "dakshitha", name: "cart-cell", ver: "1.0.0"},
        checkoutCellDep: <cellery:ImageName>{ org: "dakshitha", name: "checkout-cell", ver: "1.0.0"}
    }
};
